...
from road_to_deep_learning.naive import MLPRegressor
...
model = MLPRegressor(input_dim, 3, output_dim, batch_size=100, tol=1e-7, lr=0.001, optimizer=optimize.scipy_minimize,
